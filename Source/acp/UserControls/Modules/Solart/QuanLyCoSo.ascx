<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QuanLyCoSo.ascx.cs" Inherits="iDKCMS.BackEnd.UserControls.Modules.Solart.QuanLyCoSo" %>
<%@ Register TagPrefix="cc1" Namespace="AWS.FilePicker" Assembly="FilePickerControl, Version=2.0.1417.40067, Culture=neutral, PublicKeyToken=b6c783efc483733b" %>
<div align="center">
<asp:datagrid id="dtgData" CellPadding="2" runat="server" 
		...
		<Columns>
			<asp:BoundColumn Visible="False" DataField="Coso_ID" HeaderText="ID"></asp:BoundColumn>
			<asp:BoundColumn DataField="Coso_Name" HeaderText="T&#234;n">
...
<table class="SidePanel" cellspacing="0" cellpadding="5" width="500" border="0" id="Table1">
    ...
    <tr>
		...
		<td>
            <cc1:FilePicker ID="txtAvatar" runat="server" CssClass="solidnormal" Width="300px" fpUploadDir="/Upload/Main/" fpPopupURL="../FilePicker/FilePicker.aspx"></cc1:FilePicker>
			</td>
	</tr>
	<tr>
		<td style="width: 20%"></td>
