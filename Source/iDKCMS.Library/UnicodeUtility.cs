...
namespace iDKCMS.Library
{
	public class UnicodeUtility
	{
        ...
        public static string UnicodeToFriendlyUrl(string s)
        {
            string retVal = String.Empty;
            if (s == null)
                return retVal;
            ...
            retVal = reg.Replace(retVal, "-");

            //for (int j = 0; j < retVal.Length; j++ )
            //{
            //    if(!AllowNormalCharacter.Contains(retVal[j].ToString().ToLower()))
            //    {
            //        retVal += "-";
            //    }
            //    else
        ...
        private static ArrayList _arrNormalCharacter;
        private static ArrayList AllowNormalCharacter
        {
            get
            {
                _arrNormalCharacter = new ArrayList
                {
                    "a",
                    "b",
                    "c",
