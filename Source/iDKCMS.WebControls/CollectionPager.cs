...
namespace iDKCMS.WebControls
{
    ...
    public class CollectionPager : Control, IPostBackEventHandler
    {
        // Properties (Private)
        ...
        {
            set { this._PagedDataSet.DataSource = value; }
            get { return this._PagedDataSet.DataSource; }
        }
        ...
        public int PageSize
        {
            get { return _PagedDataSet.PageSize; }

            set { _PagedDataSet.PageSize = value; }
        }
        ...
        {
            get { return _SectionPadding; }

            set { _SectionPadding = value; }
        }
        ...
        {
            get { return _HideOnSinglePage; }

            set { _HideOnSinglePage = value; }
        }
        ...
        {
            set { _BindToControl = value.UniqueID; }
        }
        ...
        {
            get { return _ResultsStyle; }
            set { _ResultsStyle = value; }
        ...
        {
            get { return _PageNumbersDisplay; }
        ...
        {
            get { return _PageNumbersSeparator; }
        ...
        {
            get { return _PageNumbersStyle; }
            set { _PageNumbersStyle = value; }
        }
        ...
        {
            get { return _PageNumberStyle; }
            set { _PageNumberStyle = value; }
        }
        ...
        {
            get { return _BackNextStyle; }
            set { _BackNextStyle = value; }
        }
        ...
        {
            get { return _BackNextButtonStyle; }
            set { _BackNextButtonStyle = value; }
        }

        [Bindable(false), Category("Back/Next")]
        public BackNextDisplayType BackNextDisplay
        {
            get { return _BackNextDisplay; }
        ...
        {
            get { return _BackNextLinkSeparator; }

            set { _BackNextLinkSeparator = value.Trim(); }
        }
        ...
        protected virtual void BuildControl()
        {
            ...
            else
            {
                ...
                if (ResultsLocation != ResultsLocationType.None)
                {
                    Results = string.Format(ResultsFormat
                        , RecordStart
                        , RecordEnd
                        , TotalRecords);
                }
            ...
            for (int i = StartPage; i <= EndPage; i++)
            {
                ...
                else
                {
                    ...
                    if (i == currentPage)
                    {
                        if (PageNumbersDisplay == PageNumbersDisplayType.Numbers)
                        {
                            Pages.AppendFormat("<a class=\"selected\">{0}</a>", i.ToString());
                        }
                        else
                        {
                            Pages.AppendFormat("[<B>{0}-{1}</B>]", RecordStart, RecordEnd);
        ...
        protected virtual string BuildLinkNavBack(int currentPage)
        {
            ...
            if (_PagedDataSet.IsFirstPage || _PagedDataSet.DataSourceCount == 0)
            {
                ...
                LinkNav.Append("<a class=\"selected\">" + BackText + "</a>");
            }
            else
            {
                //Set up PostBack link.
                if (PagingMode == PagingModeType.PostBack)
                {
                    if (ShowFirstLast)
                    {
                        LinkNav.AppendFormat("<a id=\"{0}\" href=\"javascript:{1}\">{2}</a>&nbsp;"
                            , this.UniqueID
                            , Page.GetPostBackEventReference(this, Convert.ToString(10))
                            , FirstText);
                    }

                    LinkNav.AppendFormat("<a id=\"{0}\" href=\"javascript:{1}\">{2}</a>"
                        , this.UniqueID
                        , Page.GetPostBackEventReference(this, Convert.ToString(currentPage - 10))
                        , BackText);
                }
                else
                {
                    if (ShowFirstLast)
                    {
                        LinkNav.AppendFormat("<a href='{0}'>{1}</A>&nbsp;"
                            , UpdateQueryStringItem(Context.Request, QueryStringKey, Convert.ToString(10))
                            , FirstText);
                    }
                    LinkNav.AppendFormat("<a href='{0}'>{1}</A>"
                        , UpdateQueryStringItem(Context.Request, QueryStringKey, Convert.ToString(currentPage - 10))
                        , BackText);
                }
            }
        ...
        protected virtual string BuildLinkNavNext(int currentPage, int pageCount)
        {
            ...
            {
                LinkNav.Append("<a class=\"selected\">" + NextText + "</a>");
        ...
        protected virtual string BuildButtonNavBack(int currentPage)
        {
            ...
            else
            {
                if (PagingMode == PagingModeType.PostBack)
                {
                    ...
                    ButtonNav.AppendFormat("<INPUT TYPE=button id=\"{0}\" onclick=\"javascript:{1}\" VALUE=\"{2}\">"
                        , this.UniqueID
                        , Page.GetPostBackEventReference(this, Convert.ToString(currentPage))
                        , BackText);
                }
                else
                {
