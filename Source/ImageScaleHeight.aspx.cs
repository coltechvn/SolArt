...
{
    public partial class ImageScaleHeight : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // xac dinh % de resize
                if (smallWidth == 0)//InputBitmap.Height < InputBitmap.Width)
                {
                    scalesmall = ((double)smallHeight) / InputBitmap.Height;
                }
